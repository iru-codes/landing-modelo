 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b=new Oe("@firebase/app"),qt="@firebase/app-compat",Wt="@firebase/analytics-compat",Gt="@firebase/analytics",Kt="@firebase/app-check-compat",Yt="@firebase/app-check",Jt="@firebase/auth",Xt="@firebase/auth-compat",Qt="@firebase/database",Zt="@firebase/data-connect",en="@firebase/database-compat",tn="@firebase/functions",nn="@firebase/functions-compat",rn="@firebase/installations",an="@firebase/installations-compat",sn="@firebase/messaging",on="@firebase/messaging-compat",cn="@firebase/performance",ln="@firebase/performance-compat",dn="@firebase/remote-config",un="@firebase/remote-config-compat",fn="@firebase/storage",hn="@firebase/storage-compat",pn="@firebase/firestore",gn="@firebase/vertexai",mn="@firebase/firestore-compat",bn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ge=new Map;function Ke(e,t){const n=L(e);Ye(n,t),Gn(n,t)}function Ye(e,t){const n=Ge.get(e);if(n)for(const a of n)a(t)}function Gn(e,t){const n=Kn();n&&n.postMessage({key:e,fid:t}),Yn()}let A=null;function Kn(){return!A&&"BroadcastChannel"in self&&(A=new BroadcastChannel("[Firebase] FID Change"),A.onmessage=e=>{Ye(e.data.key,e.data.fid)}),A}function Yn(){Ge.size===0&&A&&(A.close(),A=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jn="firebase-installations-database",Xn=1,T="firebase-installations-store";let V=null;function Z(){return V||(V=Me(Jn,Xn,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(T)}}})),V}async function M(e,t){const n=L(e),r=(await Z()).transaction(T,"readwrite"),i=r.objectStore(T),s=await i.get(n);return await i.put(t,n),await r.done,(!s||s.fid!==t.fid)&&Ke(e,t.fid),t}async function Je(e){const t=L(e),a=(await Z()).transaction(T,"readwrite");await a.objectStore(T).delete(t),await a.done}async function k(e,t){const n=L(e),r=(await Z()).transaction(T,"readwrite"),i=r.objectStore(T),s=await i.get(n),o=t(s);return o===void 0?await i.delete(n):await i.put(o,n),await r.done,o&&(!s||s.fid!==o.fid)&&Ke(e,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qr{constructor(t){this.app=t}_delete(){return delete C[this.app.options.appId],Promise.resolve()}}let C={},me=[];const be={};let z="dataLayer",Wr="gtag",ye,rt,Ie=!1;function Gr(){const e=[];if(mt()&&e.push("This is a browser extension environment."),bt()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,r)=>`(${r+1}) ${a}`).join(" "),n=g.create("invalid-analytics-context",{errorInfo:t});f.warn(n.message)}}function Kr(e,t,n){Gr();const a=e.options.appId;if(!a)throw g.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)f.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw g.create("no-api-key");if(C[a]!=null)throw g.create("already-exists",{id:a});if(!Ie){Dr(z);const{wrappedGtag:i,gtagCore:s}=Br(C,me,be,z,Wr);rt=i,ye=s,Ie=!0}return C[a]=zr(e,me,be,t,ye,z,n),new qr(e)}function Yr(e=_n()){e=Ce(e);const t=N(e,$);return t.isInitialized()?t.getImmediate():Jr(e)}function Jr(e,t={}){const n=N(e,$);if(n.isInitialized()){const r=n.getImmediate();if(R(t,n.getOptions()))return r;throw g.create("already-initialized")}return n.initialize({options:t})}function Xr(e,t,n,a){e=Ce(e),Vr(rt,C[e.app.options.appId],t,n,a).catch(r=>f.error(r))}const we="@firebase/analytics",Ee="0.10.11";function Qr(){v(new E($,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),r=t.getProvider("installations-internal").getImmediate();return Kr(a,r,n)},"PUBLIC")),v(new E("analytics-internal",e,"PRIVATE")),w(we,Ee),w(we,Ee,"esm2017");function e(t){try{const n=t.getProvider($).getImmediate();return{logEvent:(a,r,i)=>Xr(n,a,r,i)}}catch(n){throw g.create("interop-component-reg-failed",{reason:n})}}}Qr();const Zr={apiKey:"AIzaSyAbg8UVtowKh_q48bchA3OowHQpTG2A6ac",authDomain:"landing-page-modelo.firebaseapp.com",projectId:"landing-page-modelo",storageBucket:"landing-page-modelo.firebasestorage.app",messagingSenderId:"151853104506",appId:"1:151853104506:web:ce500170695faa48652ac3",measurementId:"G-RQMM907D3L"},ea=$e(Zr);Yr(ea);let ta=document.querySelectorAll(".nav-link");ta.forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();let n=e.getAttribute("href").substring(1);document.getElementById(n).scrollIntoView({behavior:"smooth",block:"center"})})});let na=document.getElementById("scroll-to-top");na.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});let at=document.querySelectorAll(".card"),ra=new IntersectionObserver((e,t)=>{e.forEach(n=>{n.isIntersecting&&(Array.from(at).indexOf(n.target)%2===0?n.target.classList.add("left-visible"):n.target.classList.add("right-visible"),t.unobserve(n.target))})},{threshold:.3});at.forEach(e=>ra.observe(e));
