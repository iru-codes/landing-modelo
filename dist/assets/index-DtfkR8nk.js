 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bn(e){A(new E("platform-logger",t=>new Ut(t),"PRIVATE")),A(new E("heartbeat",t=>new Cn(t),"PRIVATE")),w(G,le,e),w(G,le,"esm2017"),w("fire-js","")}Bn("");var Mn="firebase",$n="11.2.0";/**
 * @license
