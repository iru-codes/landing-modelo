 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yt="FirebaseError";class D extends Error{constructor(t,n,a){super(n),this.code=t,this.customData=a,this.name=yt,Object.setPrototypeOf(this,D.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,P.prototype.create)}}class P{constructor(t,n,a){this.service=t,this.serviceName=n,this.errors=a}create(t,...n){const a=n[0]||{},r=`${this.service}/${t}`,i=this.errors[t],s=i?It(i,a):"Error",o=`${this.serviceName}: ${s} (${r}).`;return new D(r,o,a)}}function It(e,t){return e.replace(wt,(n,a)=>{const r=t[a];return r!=null?String(r):`<${a}?>`})}const wt=/\{\$([^}]+)}/g;function R(e,t){if(e===t)return!0;const n=Object.keys(e),a=Object.keys(t);for(const r of n){if(!a.includes(r))return!1;const i=e[r],s=t[r];if(ae(i)&&ae(s)){if(!R(i,s))return!1}else if(i!==s)return!1}for(const r of a)if(!n.includes(r))return!1;return!0}function ae(e){return e!==null&&typeof e=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Et=1e3,_t=2,At=4*60*60*1e3,vt=.5;function ie(e,t=Et,n=_t){const a=t*Math.pow(n,e),r=Math.round(vt*a*(Math.random()-.5)*2);return Math.min(At,a+r)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b=new Oe("@firebase/app"),Wt="@firebase/app-compat",qt="@firebase/analytics-compat",Gt="@firebase/analytics",Kt="@firebase/app-check-compat",Jt="@firebase/app-check",Yt="@firebase/auth",Xt="@firebase/auth-compat",Qt="@firebase/database",Zt="@firebase/data-connect",en="@firebase/database-compat",tn="@firebase/functions",nn="@firebase/functions-compat",rn="@firebase/installations",an="@firebase/installations-compat",sn="@firebase/messaging",on="@firebase/messaging-compat",cn="@firebase/performance",ln="@firebase/performance-compat",dn="@firebase/remote-config",un="@firebase/remote-config-compat",fn="@firebase/storage",hn="@firebase/storage-compat",pn="@firebase/firestore",gn="@firebase/vertexai",mn="@firebase/firestore-compat",bn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K="[DEFAULT]",yn={[G]:"fire-core",[Wt]:"fire-core-compat",[Gt]:"fire-analytics",[qt]:"fire-analytics-compat",[Jt]:"fire-app-check",[Kt]:"fire-app-check-compat",[Yt]:"fire-auth",[Xt]:"fire-auth-compat",[Qt]:"fire-rtdb",[Zt]:"fire-data-connect",[en]:"fire-rtdb-compat",[tn]:"fire-fn",[nn]:"fire-fn-compat",[rn]:"fire-iid",[an]:"fire-iid-compat",[sn]:"fire-fcm",[on]:"fire-fcm-compat",[cn]:"fire-perf",[ln]:"fire-perf-compat",[dn]:"fire-rc",[un]:"fire-rc-compat",[fn]:"fire-gcs",[hn]:"fire-gcs-compat",[pn]:"fire-fst",[mn]:"fire-fst-compat",[gn]:"fire-vertex","fire-js":"fire-js",[bn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const B=new Map,In=new Map,J=new Map;function de(e,t){try{e.container.addComponent(t)}catch(n){b.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function v(e){const t=e.name;if(J.has(t))return b.debug(`There were multiple attempts to register component ${t}.`),!1;J.set(t,e);for(const n of B.values())de(n,e);for(const n of In.values())de(n,e);return!0}function N(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const An="firebase-heartbeat-database",vn=1,O="firebase-heartbeat-store";let H=null;function Pe(){return H||(H=Me(An,vn,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(O)}catch(n){console.warn(n)}}}}).catch(e=>{throw I.create("idb-open",{originalErrorMessage:e.message})})),H}async function Sn(e){try{const n=(await Pe()).transaction(O),a=await n.objectStore(O).get(Ne(e));return await n.done,a}catch(t){if(t instanceof D)b.warn(t.message);else{const n=I.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});b.warn(n.message)}}}async function ue(e,t){try{const a=(await Pe()).transaction(O,"readwrite");await a.objectStore(O).put(t,Ne(e)),await a.done}catch(n){if(n instanceof D)b.warn(n.message);else{const a=I.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});b.warn(a.message)}}}function Ne(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bn(e){v(new E("platform-logger",t=>new Ut(t),"PRIVATE")),v(new E("heartbeat",t=>new Cn(t),"PRIVATE")),w(G,le,e),w(G,le,"esm2017"),w("fire-js","")}Bn("");var Mn="firebase",$n="11.2.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */w(Mn,$n,"app");const Le="@firebase/installations",Q="0.6.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ke=1e4,Fe=`w:${Q}`,xe="FIS_v2",Pn="https://firebaseinstallations.googleapis.com/v1",Nn=60*60*1e3,Ln="installations",kn="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zn=/^[cdef][\w-]{21}$/,Y="";function Wn(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=qn(e);return zn.test(n)?n:Y}catch{return Y}}function qn(e){return Un(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ge=new Map;function Ke(e,t){const n=L(e);Je(n,t),Gn(n,t)}function Je(e,t){const n=Ge.get(e);if(n)for(const a of n)a(t)}function Gn(e,t){const n=Kn();n&&n.postMessage({key:e,fid:t}),Jn()}let A=null;function Kn(){return!A&&"BroadcastChannel"in self&&(A=new BroadcastChannel("[Firebase] FID Change"),A.onmessage=e=>{Je(e.data.key,e.data.fid)}),A}function Jn(){Ge.size===0&&A&&(A.close(),A=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yn="firebase-installations-database",Xn=1,T="firebase-installations-store";let V=null;function Z(){return V||(V=Me(Yn,Xn,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(T)}}})),V}async function M(e,t){const n=L(e),r=(await Z()).transaction(T,"readwrite"),i=r.objectStore(T),s=await i.get(n);return await i.put(t,n),await r.done,(!s||s.fid!==t.fid)&&Ke(e,t.fid),t}async function Ye(e){const t=L(e),a=(await Z()).transaction(T,"readwrite");await a.objectStore(T).delete(t),await a.done}async function k(e,t){const n=L(e),r=(await Z()).transaction(T,"readwrite"),i=r.objectStore(T),s=await i.get(n),o=t(s);return o===void 0?await i.delete(n):await i.put(o,n),await r.done,o&&(!s||s.fid!==o.fid)&&Ke(e,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ee(e){let t;const n=await k(e.appConfig,a=>{const r=Qn(a),i=Zn(e,r);return t=i.registrationPromise,i.installationEntry});return n.fid===Y?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Qn(e){const t=e||{fid:Wn(),registrationStatus:0};return Xe(t)}function Zn(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const r=Promise.reject(S.create("app-offline"));return{installationEntry:t,registrationPromise:r}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},a=er(e,n);return{installationEntry:n,registrationPromise:a}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:tr(e)}:{installationEntry:t}}async function er(e,t){try{const n=await Vn(e,t);return M(e.appConfig,n)}catch(n){throw je(n)&&n.customData.serverCode===409?await Ye(e.appConfig):await M(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function tr(e){let t=await pe(e.appConfig);for(;t.registrationStatus===1;)await qe(100),t=await pe(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:a}=await ee(e);return a||n}return t}function pe(e){return k(e,t=>{if(!t)throw S.create("installation-not-found");return Xe(t)})}function Xe(e){return nr(e)?{fid:e.fid,registrationStatus:0}:e}function nr(e){return e.registrationStatus===1&&e.registrationTime+ke<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function te(e,t=!1){let n;const a=await k(e.appConfig,i=>{if(!Qe(i))throw S.create("not-registered");const s=i.authToken;if(!t&&or(s))return i;if(s.requestStatus===1)return n=ir(e,t),i;{if(!navigator.onLine)throw S.create("app-offline");const o=lr(i);return n=sr(e,o),o}});return n?await n:a.authToken}async function ir(e,t){let n=await ge(e.appConfig);for(;n.authToken.requestStatus===1;)await qe(100),n=await ge(e.appConfig);const a=n.authToken;return a.requestStatus===0?te(e,t):a}function ge(e){return k(e,t=>{if(!Qe(t))throw S.create("not-registered");const n=t.authToken;return dr(n)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function sr(e,t){try{const n=await rr(e,t),a=Object.assign(Object.assign({},t),{authToken:n});return await M(e.appConfig,a),n}catch(n){if(je(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await Ye(e.appConfig);else{const a=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await M(e.appConfig,a)}throw n}}function Qe(e){return e!==void 0&&e.registrationStatus===2}function or(e){return e.requestStatus===2&&!cr(e)}function cr(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+Nn}function lr(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}function dr(e){return e.requestStatus===1&&e.requestTime+ke<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ze="installations",gr="installations-internal",mr=e=>{const t=e.getProvider("app").getImmediate(),n=pr(t),a=N(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},br=e=>{const t=e.getProvider("app").getImmediate(),n=N(t,Ze).getImmediate();return{getId:()=>ur(n),getToken:r=>fr(n,r)}};function yr(){v(new E(Ze,mr,"PUBLIC")),v(new E(gr,br,"PRIVATE"))}yr();w(Le,Q);w(Le,Q,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ur(){if(Te())try{await De()}catch(e){return f.warn(g.create("indexeddb-unavailable",{errorInfo:e==null?void 0:e.toString()}).message),!1}else return f.warn(g.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function zr(e,t,n,a,r,i,s){var o;const c=Fr(e);c.then(p=>{n[p.measurementId]=p.appId,e.options.measurementId&&p.measurementId!==e.options.measurementId&&f.warn(`The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${p.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(p=>f.error(p)),t.push(c);const l=Ur().then(p=>{if(p)return a.getId()}),[u,h]=await Promise.all([c,l]);Mr(i)||Tr(i,u.measurementId),r("js",new Date);const m=(o=s==null?void 0:s.config)!==null&&o!==void 0?o:{};return m[wr]="firebase",m.update=!0,h!=null&&(m[Ir]=h),r("config",u.measurementId,m),u.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wr{constructor(t){this.app=t}_delete(){return delete C[this.app.options.appId],Promise.resolve()}}let C={},me=[];const be={};let z="dataLayer",qr="gtag",ye,rt,Ie=!1;function Gr(){const e=[];if(mt()&&e.push("This is a browser extension environment."),bt()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,r)=>`(${r+1}) ${a}`).join(" "),n=g.create("invalid-analytics-context",{errorInfo:t});f.warn(n.message)}}function Kr(e,t,n){Gr();const a=e.options.appId;if(!a)throw g.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)f.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw g.create("no-api-key");if(C[a]!=null)throw g.create("already-exists",{id:a});if(!Ie){Dr(z);const{wrappedGtag:i,gtagCore:s}=Br(C,me,be,z,qr);rt=i,ye=s,Ie=!0}return C[a]=zr(e,me,be,t,ye,z,n),new Wr(e)}function Jr(e=_n()){e=Ce(e);const t=N(e,$);return t.isInitialized()?t.getImmediate():Yr(e)}function Yr(e,t={}){const n=N(e,$);if(n.isInitialized()){const r=n.getImmediate();if(R(t,n.getOptions()))return r;throw g.create("already-initialized")}return n.initialize({options:t})}function Xr(e,t,n,a){e=Ce(e),Vr(rt,C[e.app.options.appId],t,n,a).catch(r=>f.error(r))}const we="@firebase/analytics",Ee="0.10.11";function Qr(){v(new E($,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),r=t.getProvider("installations-internal").getImmediate();return Kr(a,r,n)},"PUBLIC")),v(new E("analytics-internal",e,"PRIVATE")),w(we,Ee),w(we,Ee,"esm2017");function e(t){try{const n=t.getProvider($).getImmediate();return{logEvent:(a,r,i)=>Xr(n,a,r,i)}}catch(n){throw g.create("interop-component-reg-failed",{reason:n})}}}Qr();const Zr={apiKey:"AIzaSyBqMbStmynQsCKpztJWGJ74a27NTUDs6W4",authDomain:"landing-page-modelo.firebaseapp.com",projectId:"landing-page-modelo",storageBucket:"landing-page-modelo.firebasestorage.app",messagingSenderId:"151853104506",appId:"1:151853104506:web:ce500170695faa48652ac3",measurementId:"G-RQMM907D3L"},ea=$e(Zr);Jr(ea);let ta=document.querySelectorAll(".nav-link");ta.forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();let n=e.getAttribute("href").substring(1);document.getElementById(n).scrollIntoView({behavior:"smooth",block:"center"})})});let na=document.getElementById("scroll-to-top");na.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});let at=document.querySelectorAll(".card"),ra=new IntersectionObserver((e,t)=>{e.forEach(n=>{n.isIntersecting&&(Array.from(at).indexOf(n.target)%2===0?n.target.classList.add("left-visible"):n.target.classList.add("right-visible"),t.unobserve(n.target))})},{threshold:.3});at.forEach(e=>ra.observe(e));
